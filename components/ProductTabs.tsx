    ...
    <div className="space-y-0">
      ...
      <div className="space-y-2 py-0">
        ...
        {activeTab === "specifications" && (
          <div ref={specsRef} className="space-y-6 scroll-mt-32">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex justify-between border-b border-gray-100 pb-2">
                    <span>Diamètre</span>
                    <span className="font-medium text-gray-900">{product.diameter} cm</span>
                  </li>
                  <li className="flex justify-between border-b border-gray-100 pb-2">
                    <span>Hauteur</span>
                  ...
                  <li className="flex justify-between border-b border-gray-100 pb-2">
                    <span>Épaisseur</span>
                    <span className="font-medium text-gray-900">{product.thickness} mm</span>
                  </li>
                  <li className="flex justify-between border-b border-gray-100 pb-2">
                    <span>Poids</span>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  ...
                  <li className="flex justify-between border-b border-gray-100 pb-2">
                    <span>Type d'acier</span>
                    <span className="font-medium text-gray-900">{product.specs.acier}</span>
                  </li>
                  <li className="flex justify-between border-b border-gray-100 pb-2">
                    <span>Épaisseur bol</span>
                    <span className="font-medium text-gray-900">{product.specs.epaisseur}</span>
                  </li>
                  <li className="flex justify-between border-b border-gray-100 pb-2">
                    <span>Fabrication</span>
                    <span className="font-medium text-gray-900">{product.madeIn}</span>
                  </li>
                </ul>
              </div>
            </div>
            {product.specs.compatibilite && (
              <div className="mt-4 rounded-lg bg-orange-50 p-4">
                <p className="text-sm text-orange-800">
                  <span className="font-semibold">Compatibilité :</span> {product.specs.compatibilite}
                </p>
              </div>
            )}
          </div>
