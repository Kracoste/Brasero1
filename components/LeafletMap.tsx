...
const LeafletMapInner = dynamic(() => import("@/components/LeafletMapClient"), {
  ssr: false,
  loading: () => (
    <div className="flex h-[280px] w-full items-center justify-center border border-slate-800 bg-gradient-to-br from-slate-50 to-slate-100 text-sm text-slate-400">
