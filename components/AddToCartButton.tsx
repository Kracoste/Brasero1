  ...
  return (
    <div className={`flex flex-col gap-4 ${className}`}>
      ...
      <button
        ...
        className={`flex items-center justify-center gap-2 rounded-full px-6 py-3 font-semibold text-white shadow-lg transition ${
          added
            ? 'bg-emerald-600 hover:bg-emerald-700'
            : 'bg-clay-900 hover:bg-clay-800 hover:-translate-y-0.5'
