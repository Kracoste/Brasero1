...
import { LayoutDashboard, Package, ShoppingCart, Users, Settings, ChevronLeft, Menu, X, FileText, Ticket, ChefHat } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/recettes', icon: ChefHat, label: 'Recettes' },
