    ...
    const fetchStats = async () => {
      ...
      try {
        ...
        setStats({
          ...
          revenueToday: revenueTodayResult.data?.total_sum || 0,
          revenueThisWeek: revenueWeekResult.data?.total_sum || 0,
          revenueThisMonth: revenueMonthResult.data?.total_sum || 0,
          revenueThisYear: revenueYearResult.data?.total_sum || 0,
