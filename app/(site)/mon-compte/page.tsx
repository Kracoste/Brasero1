              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    value={user?.email || ''}
                    disabled
                    className="mt-1 block w-full rounded-lg border border-slate-300 bg-slate-50 px-3 py-2 text-slate-500"
                  />
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full rounded-lg border border-slate-300 px-3 py-2 text-slate-900 focus:border-clay-900 focus:outline-none focus:ring-clay-900"
                  />
                </div>
                <div>
