        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-slate-900 leading-tight">
              Fabrication <span className="text-[#475569]">artisanale</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center gap-4 sm:gap-8 text-sm">
            <span className="flex items-center gap-2 text-[#0f172a] font-semibold">
              <span className="w-6 h-6 bg-[#0f172a] text-white flex items-center justify-center text-xs">1</span>
              Fabrication
            </span>
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex-shrink-0">
                  <span className="text-5xl sm:text-6xl font-display font-bold text-[#475569]/30">
                    {step.number}
                  </span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {materials.map((material) => (
              <div key={material.title} className="bg-[#f1f5f9] p-6 sm:p-8 border border-slate-200">
                <div className="w-14 h-14 bg-[#475569]/20 flex items-center justify-center mb-4">
                  <material.icon className="w-7 h-7 text-[#475569]" />
                </div>
            ...
            {values.map((value) => (
              <div key={value.title} className="bg-white border border-slate-200 shadow-sm p-6 sm:p-8 text-center">
                <div className="w-14 h-14 bg-[#475569]/20 flex items-center justify-center mx-auto mb-4">
                  <value.icon className="w-7 h-7 text-[#475569]" />
                </div>
